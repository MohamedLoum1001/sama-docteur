...
import Specialites from "./pages/admin/specialites/Specialites";
import Paiements from "./pages/admin/paiements/Paiements";
import AvisAdmin from "./pages/admin/avisAdmin/AvisAdmin";
    ...
    <div className="App">
      <Routes>
        ...
        <Route element={<Layout />}>
          ...
          <Route path="/avis-admin" element={<ProtectedRoute><AvisAdmin /></ProtectedRoute>} />
